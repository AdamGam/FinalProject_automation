...
public class CommonOps extends Base{
 ...
 Method Description : this method call to web browser driver
 Method Parameters : String
 Method return  : String
 ###############################################################################
 */
 ...
 Method Description : this method open the chrome browser
 Method Parameters : String
 Method return  : String
 ###############################################################################
 */
...
Method Description : this method open the firefox browser
Method Parameters : String
Method return  : String
###############################################################################
*/
...
###############################################################################
Method name : initAPI
Method Description : this method get a data by list
Method Parameters : String
Method return  : String
###############################################################################
*/
...
Method Description : this method open the application in mobile
Method Parameters : String
Method return  : String
###############################################################################
*/
...
Method Description : this method get the driver application by path and open the (todolist) application
Method Parameters : String
Method return  : String
###############################################################################
*/
...
Method Description : this method open the Calculator application
Method Parameters : String
Method return  : String
###############################################################################
*/
...
//        driver.get(getData("url"));
    ...
    public void beforeMethod(Method method) {
        if(!platform.equalsIgnoreCase("api")) {
            try {
                MonteScreenRecorder.startRecording(method.getName());
            } catch (Exception e) {
